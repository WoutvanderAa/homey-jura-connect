...
/**
 * Machine profile for EF1100, extracted from the JOE Android app's
 * bundled machine-catalogue XML (via the jura_connect PyPI package,
 * data/xml/EF1100/*.xml). See lib/profiles/README.md for how this
...
const PROFILE = {
  ...
  "products": [
    ...
    },
    {
      "code": 20,
      "name": "2x_cappuccino",
      "rawName": "2x Cappuccino",
      "active": false,
      "params": []
    },
    {
      "code": 23,
      "name": "2x_latte_macchiato",
      "rawName": "2x Latte Macchiato",
      "active": false,
      "params": []
    },
    {
