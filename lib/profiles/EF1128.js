...
/**
 * Machine profile for EF1128, extracted from the JOE Android app's
 * bundled machine-catalogue XML (via the jura_connect PyPI package,
 * data/xml/EF1128/*.xml). See lib/profiles/README.md for how this
...
const PROFILE = {
  ...
  "products": [
    ...
    {
      "code": 40,
      "name": "cafe_barista_americano",
      "rawName": "Cafe Barista / Americano",
      "active": true,
      "params": [
        {
          "kind": "coffee_strength",
