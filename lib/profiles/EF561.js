...
/**
 * Machine profile for EF561, extracted from the JOE Android app's
 * bundled machine-catalogue XML (via the jura_connect PyPI package,
 * data/xml/EF561/*.xml). See lib/profiles/README.md for how this
...
const PROFILE = {
  ...
  "products": [
    ...
    {
      "code": 23,
      "name": "2_latte_macchiati",
      "rawName": " 2 Latte Macchiati",
      "active": true,
      "params": [
        {
          "kind": "water_amount",
    ...
    {
      "code": 61,
      "name": "hotwater_portion_black_tea",
      "rawName": "Hotwater Portion(black tea)",
      "active": true,
      "params": [
        {
          "kind": "water_amount",
