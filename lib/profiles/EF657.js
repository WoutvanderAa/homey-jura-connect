...
/**
 * Machine profile for EF657, extracted from the JOE Android app's
 * bundled machine-catalogue XML (via the jura_connect PyPI package,
 * data/xml/EF657/*.xml). See lib/profiles/README.md for how this
...
const PROFILE = {
  ...
  "products": [
    ...
    {
      "code": 22,
      "name": "2_espresso_macchiati",
      "rawName": "2 Espresso Macchiati",
      "active": true,
      "params": [
        {
          "kind": "grinder_ratio",
