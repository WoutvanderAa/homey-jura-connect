...
/**
 * Machine profile for EF532coffeeonly, extracted from the JOE Android app's
 * bundled machine-catalogue XML (via the jura_connect PyPI package,
 * data/xml/EF532coffeeonly/*.xml). See lib/profiles/README.md for how this
 * was generated. Not live-verified -- see README.md "What's verified".
 */

const PROFILE = {
  "code": "EF532coffeeonly",
  "products": [
    {
      "code": 2,
      "name": "espresso",
