...
/**
 * Machine profile for EF532V2, extracted from the JOE Android app's
 * bundled machine-catalogue XML (via the jura_connect PyPI package,
 * data/xml/EF532V2/*.xml). See lib/profiles/README.md for how to add
 * more profiles the same way.
 */
