...
/**
 * Machine profile for EF658_c, extracted from the JOE Android app's
 * bundled machine-catalogue XML (via the jura_connect PyPI package,
 * data/xml/EF658_c/*.xml). See lib/profiles/README.md for how this
...
const PROFILE = {
  ...
  "products": [
    ...
    {
      "code": 55,
      "name": "latte_macchiato_big",
      "rawName": "Latte Macchiato Big",
      "active": true,
      "params": [
        {
          "kind": "coffee_strength",
    ...
    {
      "code": 61,
      "name": "hotwater_portion_big",
      "rawName": "Hotwater Portion Big",
      "active": true,
      "params": [
        {
          "kind": "water_amount",
