...
/**
 * Machine profile for EF1096, extracted from the JOE Android app's
 * bundled machine-catalogue XML (via the jura_connect PyPI package,
 * data/xml/EF1096/*.xml). See lib/profiles/README.md for how this
...
const PROFILE = {
  ...
  "alerts": [
    ...
    {
      "bit": 56,
      "name": "coffee_eye_cup_detected",
      "severity": "info",
      "rawName": "Coffee Eye (cup detected)"
    }
  ]
};
