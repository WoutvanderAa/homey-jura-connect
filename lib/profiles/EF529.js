...
/**
 * Machine profile for EF529, extracted from the JOE Android app's
 * bundled machine-catalogue XML (via the jura_connect PyPI package,
 * data/xml/EF529/*.xml). See lib/profiles/README.md for how this
...
const PROFILE = {
  ...
  "products": [
    ...
    {
      "code": 1,
      "name": "ristretto_only_joe",
      "rawName": "Ristretto (only JOE)",
      "active": true,
      "params": [
        {
          "kind": "coffee_strength",
    ...
    {
      "code": 40,
      "name": "cafe_barista_only_joe",
      "rawName": "Cafe Barista (only JOE)",
      "active": true,
      "params": [
        {
          "kind": "coffee_strength",
    ...
    {
      "code": 41,
      "name": "barista_lungo_only_joe",
      "rawName": "Barista Lungo (only JOE)",
      "active": true,
      "params": [
        {
          "kind": "coffee_strength",
    ...
    {
      "code": 48,
      "name": "espresso_doppio_only_joe",
      "rawName": "Espresso Doppio (only JOE)",
      "active": true,
      "params": [
        {
          "kind": "coffee_strength",
    ...
    {
      "code": 17,
      "name": "2_ristretti_only_joe",
      "rawName": "2 Ristretti (only JOE)",
      "active": true,
      "params": [
        {
          "kind": "water_amount",
