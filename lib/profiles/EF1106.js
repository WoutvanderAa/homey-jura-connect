...
/**
 * Machine profile for EF1106, extracted from the JOE Android app's
 * bundled machine-catalogue XML (via the jura_connect PyPI package,
 * data/xml/EF1106/*.xml). See lib/profiles/README.md for how this
...
const PROFILE = {
  ...
  "products": [
    ...
    {
      "code": 28,
      "name": "chocolate_milkfoam",
      "rawName": "Chocolate Milkfoam",
      "active": true,
      "params": [
        {
          "kind": "milk_foam_amount",
