...
/**
 * Machine profile for EF542, extracted from the JOE Android app's
 * bundled machine-catalogue XML (via the jura_connect PyPI package,
 * data/xml/EF542/*.xml). See lib/profiles/README.md for how this
...
const PROFILE = {
  ...
  "products": [
    ...
    {
      "code": 57,
      "name": "2_barista_lungo",
      "rawName": "2 Barista Lungo",
      "active": true,
      "params": [
        {
          "kind": "water_amount",
