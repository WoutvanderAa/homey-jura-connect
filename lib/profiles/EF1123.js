...
/**
 * Machine profile for EF1123, extracted from the JOE Android app's
 * bundled machine-catalogue XML (via the jura_connect PyPI package,
 * data/xml/EF1123/*.xml). See lib/profiles/README.md for how this
...
const PROFILE = {
  ...
  "products": [
    ...
    {
      "code": 45,
      "name": "1_hotwater_portion_green_tea",
      "rawName": "1 Hotwater Portion(Green tea)",
      "active": true,
      "params": [
        {
          "kind": "water_amount",
