...
/**
 * Machine profile for EF533V2, extracted from the JOE Android app's
 * bundled machine-catalogue XML (via the jura_connect PyPI package,
 * data/xml/EF533V2/*.xml). Product codes, recipe parameter
 * byte-offsets and alert bit numbers are specific to this exact
 * machine profile -- they differ between Jura models, sometimes
 * even between hardware revisions of the 'same' model, which is
 * why this is bundled data rather than a hand-typed guess.
 */
...
const PROFILE = {
  ...
  "products": [
    ...
    {
      "code": 13,
      "name": "hotwater_portion_normal",
      "rawName": "Hotwater Portion(normal)",
      "active": true,
      "params": [
        {
          "kind": "water_amount",
    ...
    {
      "code": 47,
      "name": "1_coffee_special",
      "rawName": "1 coffee special",
      "active": true,
      "params": [
        {
          "kind": "coffee_strength",
    ...
    {
      "code": 63,
      "name": "2_coffee_special",
      "rawName": "2 coffee special",
      "active": true,
      "params": [
        {
          "kind": "water_amount",
